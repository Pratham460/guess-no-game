...
def checkC():
    ...
    if int(text_input) not in numbers:
       messagebox.showinfo('Message','Number does not exist in the list')
...
label=tk.Label(window,text="Total chances are: 3",fg="purple",font=("arial",17))
